...
## !important
The source code is a GPU version of the implicit slicing of highly complex lattice structures presented in [1,2]. It can be compiled with QT 5.10+MSVC 14.0, and run on the operating system Windows 10.
